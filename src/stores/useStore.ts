...
export interface MusicTrack {
  ...
  name: BiText;
  category: BiText;
  kind: 'scene' | 'instrumental' | 'frequency';
  icon: string;
  color: string;
  scene: BiText;
  target: BiText;
...
export const DAILY_AUDIO_TRACKS: MusicTrack[] = [
  {
    id: 'rain-long-loop',
    name: { zh: '窗边长雨', en: 'Long Rain by the Window' },
    category: { zh: '自然场景', en: 'Nature Scene' },
    kind: 'scene',
    icon: '☂',
    color: '#5b9ab4',
    scene: { zh: '写日志、阅读、睡前放空', en: 'Journaling, reading, winding down' },
    target: { zh: '用连续雨声遮蔽突发噪音，给注意力一个柔和背景', en: 'Mask sudden noise with a soft rain bed' },
    frequency: '自然雨声 · 无频率叠加',
    intensity: '低',
    tags: ['雨声', '睡前', '白噪音'],
    layers: [82, 164, 328],
    texture: 'sine',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/rain-long-loop.mp3`,
    durationSec: 57,
    source: { zh: 'Mixkit 免费音效 · Rain long loop', en: 'Mixkit Free SFX · Rain long loop' },
  },
  {
    id: 'morning-forest',
    name: { zh: '晨间森林', en: 'Morning Forest' },
    category: { zh: '自然场景', en: 'Nature Scene' },
    kind: 'scene',
    icon: '♧',
    color: '#6d9a76',
    scene: { zh: '晨间整理、阳台静坐、轻松工作', en: 'Morning reset, sitting, light work' },
    target: { zh: '以真实鸟鸣和林间环境建立清新、开放的空间感', en: 'Create an open, fresh sense of space' },
    frequency: '森林鸟鸣 · 无频率叠加',
    intensity: '低',
    tags: ['森林', '鸟鸣', '晨间'],
    layers: [110, 220, 330],
    texture: 'triangle',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/morning-forest.mp3`,
    durationSec: 210,
    source: { zh: 'Mixkit 免费音效 · Morning birds', en: 'Mixkit Free SFX · Morning birds' },
  },
  {
    id: 'ocean-birds',
    name: { zh: '海岸呼吸', en: 'Ocean Breath' },
    category: { zh: '自然场景', en: 'Nature Scene' },
    kind: 'scene',
    icon: '≋',
    color: '#4b9da0',
    scene: { zh: '呼吸练习、焦虑时降速、午间休息', en: 'Breathwork, slowing down, midday rest' },
    target: { zh: '跟随海浪的自然起伏延长呼气，让节奏慢下来', en: 'Use wave motion to support a slower rhythm' },
    frequency: '海浪与海鸟 · 无频率叠加',
    intensity: '低',
    tags: ['海浪', '呼吸', '放松'],
    layers: [74, 148, 296],
    texture: 'sine',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/ocean-birds.mp3`,
    durationSec: 38,
    source: { zh: 'Mixkit 免费音效 · Sea waves with birds loop', en: 'Mixkit Free SFX · Sea waves with birds loop' },
  },
  {
    id: 'quiet-cafe',
    name: { zh: '安静咖啡馆', en: 'Quiet Cafe' },
    category: { zh: '日常环境', en: 'Daily Ambience' },
    kind: 'scene',
    icon: '▤',
    color: '#b78359',
    scene: { zh: '阅读、写作、独自办公', en: 'Reading, writing, solo work' },
    target: { zh: '用温和人声底噪营造陪伴感，不占用语言注意力', en: 'Add gentle social presence without demanding attention' },
    frequency: '咖啡馆环境 · 无频率叠加',
    intensity: '中',
    tags: ['咖啡馆', '陪伴', '办公'],
    layers: [120, 180, 240],
    texture: 'triangle',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/quiet-cafe.mp3`,
    durationSec: 120,
    source: { zh: 'Mixkit 免费音效 · Restaurant crowd talking ambience', en: 'Mixkit Free SFX · Restaurant crowd talking ambience' },
  },
  {
    id: 'wind-ambience',
    name: { zh: '旷野柔风', en: 'Open Field Wind' },
    category: { zh: '自然场景', en: 'Nature Scene' },
    kind: 'scene',
    icon: '〰',
    color: '#75a69a',
    scene: { zh: '午后放空、散步想象、轻度专注', en: 'Afternoon reset, imagined walking, light focus' },
    target: { zh: '用连续风声清理拥挤感，营造开阔、可呼吸的心理空间', en: 'Create an open, breathable mental space with steady wind' },
    frequency: '自然风声 · 无频率叠加',
    intensity: '低',
    tags: ['风声', '开阔', '放空'],
    layers: [96, 192, 384],
    texture: 'sine',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/wind-ambience.mp3`,
    durationSec: 62,
    source: { zh: 'Mixkit 免费音效 · Wind blowing ambience', en: 'Mixkit Free SFX · Wind blowing ambience' },
  },
  {
    id: 'flowing-water',
    name: { zh: '清溪流动', en: 'Flowing Stream' },
    category: { zh: '自然场景', en: 'Nature Scene' },
    kind: 'scene',
    icon: '≈',
    color: '#5da4a6',
    scene: { zh: '正念聆听、午间恢复、阅读陪伴', en: 'Mindful listening, midday recovery, reading' },
    target: { zh: '让细密水流承接杂念，帮助注意力温和回到当下', en: 'Let fine water movement carry distraction back to the present' },
    frequency: '真实流水声 · 无频率叠加',
    intensity: '低',
    tags: ['流水', '正念', '阅读'],
    layers: [88, 176, 352],
    texture: 'sine',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/flowing-water.mp3`,
    durationSec: 51,
    source: { zh: 'Mixkit 免费音效 · Water flowing ambience loop', en: 'Mixkit Free SFX · Water flowing ambience loop' },
  },
  {
    id: 'night-forest',
    name: { zh: '夜林虫鸣', en: 'Night Forest' },
    category: { zh: '自然场景', en: 'Nature Scene' },
    kind: 'scene',
    icon: '☾',
    color: '#7776a7',
    scene: { zh: '夜间静坐、关灯休息、睡前阅读', en: 'Evening sitting, lights-out rest, bedtime reading' },
    target: { zh: '用稳定虫鸣建立夜晚边界，让白天的高唤醒逐步收束', en: 'Use steady insects to gently close the day' },
    frequency: '夜林虫鸣 · 无频率叠加',
    intensity: '低',
    tags: ['虫鸣', '夜晚', '睡前'],
    layers: [72, 144, 288],
    texture: 'sine',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/night-forest.mp3`,
    durationSec: 84,
    source: { zh: 'Mixkit 免费音效 · Night forest with insects', en: 'Mixkit Free SFX · Night forest with insects' },
  },
  {
    id: 'harbor-waves',
    name: { zh: '港湾轻浪', en: 'Harbor Waves' },
    category: { zh: '自然场景', en: 'Nature Scene' },
    kind: 'scene',
    icon: '∿',
    color: '#4c91aa',
    scene: { zh: '慢呼吸、情绪降速、短暂闭目休息', en: 'Slow breathing, emotional downshift, eyes-closed rest' },
    target: { zh: '用靠岸浪声提供稳定节律，帮助呼吸自然变慢', en: 'Use shore waves as a steady cue for slower breathing' },
    frequency: '港湾海浪 · 无频率叠加',
    intensity: '低',
    tags: ['海浪', '港湾', '呼吸'],
    layers: [80, 160, 320],
    texture: 'sine',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/harbor-waves.mp3`,
    durationSec: 78,
    source: { zh: 'Mixkit 免费音效 · Small waves harbor rocks', en: 'Mixkit Free SFX · Small waves harbor rocks' },
  },
  {
    id: 'woodland-waterfall',
    name: { zh: '林间瀑布', en: 'Woodland Waterfall' },
    category: { zh: '白噪音', en: 'White Noise' },
    kind: 'scene',
    icon: '≋',
    color: '#488f8b',
    scene: { zh: '深度工作、屏蔽环境杂音、午后恢复', en: 'Deep work, noise masking, afternoon recovery' },
    target: { zh: '用饱满连续的瀑布声覆盖不规则干扰，形成稳定声幕', en: 'Mask irregular distractions with a full, steady water curtain' },
    frequency: '天然宽频水声 · 白噪音感',
    intensity: '中',
    tags: ['瀑布', '白噪音', '屏蔽'],
    layers: [100, 200, 400],
    texture: 'triangle',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/woodland-waterfall.mp3`,
    durationSec: 83,
    source: { zh: 'Mixkit 免费音效 · Waterfall in the woods', en: 'Mixkit Free SFX · Waterfall in the woods' },
  },
  {
    id: 'campfire-night',
    name: { zh: '夜风篝火', en: 'Campfire Night' },
    category: { zh: '日常环境', en: 'Daily Ambience' },
    kind: 'scene',
    icon: '♨',
    color: '#c17a52',
    scene: { zh: '独处阅读、夜间复盘、温暖陪伴', en: 'Solo reading, evening review, warm company' },
    target: { zh: '以火焰噼啪声和轻风营造安全、有人陪伴般的温暖感', en: 'Create a safe, companionable warmth with fire and night wind' },
    frequency: '篝火与夜风 · 无频率叠加',
    intensity: '低',
    tags: ['篝火', '夜风', '陪伴'],
    layers: [92, 184, 368],
    texture: 'triangle',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/campfire-night.mp3`,
    durationSec: 31,
    source: { zh: 'Mixkit 免费音效 · Campfire night wind', en: 'Mixkit Free SFX · Campfire night wind' },
  },
  {
    id: 'valley-sunset',
    name: { zh: '山谷落日', en: 'Valley Sunset' },
    category: { zh: '冥想纯音乐', en: 'Meditation Music' },
    kind: 'instrumental',
    icon: '◒',
    color: '#8b78a2',
    scene: { zh: '静坐、拉伸、傍晚情绪过渡', en: 'Meditation, stretching, evening transition' },
    target: { zh: '用缓慢氛围纯音乐承接情绪，不加入语言内容', en: 'Hold emotion with slow instrumental ambience' },
    frequency: '氛围纯音乐 · 无频率功效主张',
    intensity: '低',
    tags: ['纯音乐', '冥想', '傍晚'],
    layers: [110, 220, 440],
    texture: 'sine',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/valley-sunset.mp3`,
    durationSec: 134,
    source: { zh: 'Mixkit 音乐 · Alejandro Magaña', en: 'Mixkit Music · Alejandro Magaña' },
  },
  {
    id: 'relaxation-flute',
    name: { zh: '静心长笛', en: 'Relaxation 05' },
    category: { zh: '冥想纯音乐', en: 'Meditation Music' },
    kind: 'instrumental',
    icon: '♩',
    color: '#c19368',
    scene: { zh: '瑜伽、冥想、沐浴和睡前放松', en: 'Yoga, meditation, bathing, bedtime' },
    target: { zh: '用长笛与竖琴的舒缓旋律留出内在空间', en: 'Create inner space with flute and harp' },
    frequency: '长笛竖琴纯音乐 · 无频率功效主张',
    intensity: '低',
    tags: ['长笛', '竖琴', '静心'],
    layers: [132, 264, 396],
    texture: 'sine',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/relaxation-flute.mp3`,
    durationSec: 118,
    source: { zh: 'Mixkit 音乐 · Lily J', en: 'Mixkit Music · Lily J' },
  },
  {
    id: 'relax-beat',
    name: { zh: '舒缓律动', en: 'Relax Beat' },
    category: { zh: '冥想纯音乐', en: 'Meditation Music' },
    kind: 'instrumental',
    icon: '♬',
    color: '#a78291',
    scene: { zh: '伸展、瑜伽、轻松整理空间', en: 'Stretching, yoga, gentle tidying' },
    target: { zh: '用轻柔稳定的节拍维持行动感，同时避免过度刺激', en: 'Maintain gentle momentum without overstimulation' },
    frequency: '舒缓节拍纯音乐 · 无频率功效主张',
    intensity: '低',
    tags: ['舒缓', '律动', '瑜伽'],
    layers: [104, 208, 416],
    texture: 'sine',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/relax-beat.mp3`,
    durationSec: 108,
    source: { zh: 'Mixkit 音乐 · Arulo', en: 'Mixkit Music · Arulo' },
  },
  {
    id: 'spirit-in-woods',
    name: { zh: '林中灵息', en: 'Spirit in the Woods' },
    category: { zh: '冥想纯音乐', en: 'Meditation Music' },
    kind: 'instrumental',
    icon: '♧',
    color: '#789473',
    scene: { zh: '自然冥想、书写、自我对话', en: 'Nature meditation, writing, inner dialogue' },
    target: { zh: '以空灵林间氛围支持内省，让念头缓慢展开', en: 'Support reflection with an airy woodland atmosphere' },
    frequency: '自然氛围纯音乐 · 无频率功效主张',
    intensity: '低',
    tags: ['林间', '空灵', '内省'],
    layers: [108, 216, 432],
    texture: 'sine',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/spirit-in-woods.mp3`,
    durationSec: 113,
    source: { zh: 'Mixkit 音乐 · Alejandro Magaña', en: 'Mixkit Music · Alejandro Magaña' },
  },
  {
    id: 'forest-treasure',
    name: { zh: '森林秘境', en: 'Forest Treasure' },
    category: { zh: '冥想纯音乐', en: 'Meditation Music' },
    kind: 'instrumental',
    icon: '✧',
    color: '#698e76',
    scene: { zh: '呼吸观察、想象练习、安静创作', en: 'Breath awareness, visualization, quiet creation' },
    target: { zh: '用细腻环境旋律营造探索感，陪伴不带压力的专注', en: 'Pair pressure-free focus with a gentle sense of discovery' },
    frequency: '森林氛围纯音乐 · 无频率功效主张',
    intensity: '低',
    tags: ['森林', '想象', '创作'],
    layers: [112, 224, 448],
    texture: 'sine',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/forest-treasure.mp3`,
    durationSec: 104,
    source: { zh: 'Mixkit 音乐 · Alejandro Magaña', en: 'Mixkit Music · Alejandro Magaña' },
  },
  {
    id: 'meditation',
    name: { zh: '静观冥想', en: 'Meditation' },
    category: { zh: '冥想纯音乐', en: 'Meditation Music' },
    kind: 'instrumental',
    icon: '◉',
    color: '#887a9e',
    scene: { zh: '正式静坐、身体扫描、慢呼吸练习', en: 'Sitting meditation, body scan, slow breathing' },
    target: { zh: '提供简洁、不抢注意力的背景，帮助觉察停留在身体与呼吸', en: 'Keep awareness with body and breath through a minimal backdrop' },
    frequency: '极简冥想纯音乐 · 无频率功效主张',
    intensity: '低',
    tags: ['冥想', '身体扫描', '呼吸'],
    layers: [106, 212, 424],
    texture: 'sine',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/meditation.mp3`,
    durationSec: 118,
    source: { zh: 'Mixkit 音乐 · Arulo', en: 'Mixkit Music · Arulo' },
  },
  {
    id: 'smooth-meditation',
    name: { zh: '柔光冥想', en: 'Smooth Meditation' },
    category: { zh: '冥想纯音乐', en: 'Meditation Music' },
    kind: 'instrumental',
    icon: '○',
    color: '#a08bb1',
    scene: { zh: '沐浴、睡前整理、情绪恢复', en: 'Bathing, bedtime reset, emotional recovery' },
    target: { zh: '用圆润绵长的旋律减少突兀感，温和承接疲惫情绪', en: 'Hold tired emotion with smooth, rounded musical movement' },
    frequency: '柔和氛围纯音乐 · 无频率功效主张',
    intensity: '低',
    tags: ['柔和', '睡前', '恢复'],
    layers: [102, 204, 408],
    texture: 'sine',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/smooth-meditation.mp3`,
    durationSec: 154,
    source: { zh: 'Mixkit 音乐 · Arulo', en: 'Mixkit Music · Arulo' },
  },
  {
    id: 'yoga-tune',
    name: { zh: '瑜伽舒展', en: 'Yoga Tune' },
    category: { zh: '冥想纯音乐', en: 'Meditation Music' },
    kind: 'instrumental',
    icon: '⌁',
    color: '#c08b75',
    scene: { zh: '瑜伽、晨间拉伸、身体唤醒', en: 'Yoga, morning stretch, body activation' },
    target: { zh: '以轻盈旋律陪伴缓慢动作，让身体在不过载的节奏中展开', en: 'Support slow movement with a light, unhurried rhythm' },
    frequency: '瑜伽纯音乐 · 无频率功效主张',
    intensity: '低',
    tags: ['瑜伽', '拉伸', '晨间'],
    layers: [116, 232, 464],
    texture: 'sine',
    assetUrl: `${import.meta.env.BASE_URL}audio/scenes/yoga-tune.mp3`,
    durationSec: 97,
    source: { zh: 'Mixkit 音乐 · Arulo', en: 'Mixkit Music · Arulo' },
  },
]

export const FREQUENCY_TRACKS: MusicTrack[] = ([
  {
    id: 'morning-boot',
...
] satisfies Omit<MusicTrack, 'assetUrl' | 'durationSec' | 'source' | 'kind'>[]).map((track) => ({
  ...track,
  kind: 'frequency' as const,
  assetUrl: `${import.meta.env.BASE_URL}audio/${track.id}.wav`,
  durationSec: 45,
  source: { zh: 'HOS 原创程序化频率音场', en: 'HOS original procedural frequency field' },
}));

export const MUSIC_TRACKS: MusicTrack[] = [...DAILY_AUDIO_TRACKS, ...FREQUENCY_TRACKS]
